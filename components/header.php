...
<div name="title" class="container p-5" align="center"><h1><svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-hdd-rack" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
...
</svg> ServerList</h1><h4 class="text-muted">Displaying the list of some servers has never been so easy</h4></div>
